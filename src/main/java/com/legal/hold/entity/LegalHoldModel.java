...
public class LegalHoldModel implements RowMapper<LegalHoldModel> {
	...
	public LegalHoldModel mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		legalHoldModel.setMattername(rs.getString(7));
		legalHoldModel.setMatteridentifier(rs.getString(8));
		legalHoldModel.setMatterkey(rs.getString(9));
		legalHoldModel.setSilentcustodian(rs.getString(10));
